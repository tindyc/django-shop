...
class ProductSpecification(models.Model):
    """
    The Product Specification Table contains product specification or features for the producr types.
    """
...
class ProductSpecificationValue(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("Product Spcification Values")
...
class ProductImage(models.Model):
    ...
    image = models.ImageField(
        ...
        help_text=_("Upoad a product image"),
        upload_to="images/",
        default="images/default.png",
    )
    alt_text = models.CharField(
        verbose_name=_("Alternative text"),
        help_text=_("Please add alterative test"),
        max_length=255,
        null=True,
        blank=True,
    )
